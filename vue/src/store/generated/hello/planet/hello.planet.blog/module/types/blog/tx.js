...
export class MsgClientImpl {
    ...
    CreateTimedoutPost(request) {
        ...
        const promise = this.rpc.request("hello.planet.blog.Msg", "CreateTimedoutPost", data);
    ...
    UpdateTimedoutPost(request) {
        ...
        const promise = this.rpc.request("hello.planet.blog.Msg", "UpdateTimedoutPost", data);
    ...
    DeleteTimedoutPost(request) {
        ...
        const promise = this.rpc.request("hello.planet.blog.Msg", "DeleteTimedoutPost", data);
    ...
    CreateSentPost(request) {
        ...
        const promise = this.rpc.request("hello.planet.blog.Msg", "CreateSentPost", data);
    ...
    UpdateSentPost(request) {
        ...
        const promise = this.rpc.request("hello.planet.blog.Msg", "UpdateSentPost", data);
